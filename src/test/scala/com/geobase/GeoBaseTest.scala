...
class GeoBaseTest extends FunSuite with PrivateMethodTester {
	...
	test("Geo Type Getter (domestic, conti., interconti.)") {
		...
		assert(geoBase.getGeoType(List("CDG", "PAR")) === Success(GeoType.DOMESTIC))
		assert(geoBase.getGeoType(List("CDG", "NCE", "NCE", "TLS")) === Success(GeoType.DOMESTIC))
		assert(geoBase.getGeoType(List("CDG", "NCE", "NCE", "CDG")) === Success(GeoType.DOMESTIC))

		assert(geoBase.getGeoType(List("CDG", "FRA")) === Success(GeoType.CONTINENTAL))
		assert(geoBase.getGeoType(List("CDG", "TLS", "DUB", "FRA")) === Success(GeoType.CONTINENTAL))
		assert(geoBase.getGeoType(List("CDG", "TLS", "DUB", "FRA", "CDG")) === Success(GeoType.CONTINENTAL))

		assert(geoBase.getGeoType(List("CDG", "JFK")) === Success(GeoType.INTER_CONTINENTAL))
		assert(geoBase.getGeoType(List("PAR", "JFK")) === Success(GeoType.INTER_CONTINENTAL))
		assert(geoBase.getGeoType(List("PAR", "NYC")) === Success(GeoType.INTER_CONTINENTAL))
		...
		assert(geoBase.getGeoType(List("FR", "FR", "DE")) === Success(GeoType.CONTINENTAL))
		assert(geoBase.getGeoType(List("FR", "GB", "DE")) === Success(GeoType.CONTINENTAL))
		assert(geoBase.getGeoType(List("FR", "PAR", "DUB")) === Success(GeoType.CONTINENTAL))
		assert(geoBase.getGeoType(List("US", "PAR", "DUB")) === Success(GeoType.INTER_CONTINENTAL))
	...
	test("Local Date to GMT Date") {
		...
		assert(geoBase.localDateToGMT("20160606_1627", "NCE") === Success("20160606_1427"))
		assert(geoBase.localDateToGMT("20160606_1627", "NCE", "yyyyMMdd_HHmm") === Success("20160606_1427"))

		// 2: LON
		assert(geoBase.localDateToGMT("20160606_1527", "LON") === Success("20160606_1427"))

		// 3: NYC:
		assert(geoBase.localDateToGMT("20160606_1027", "JFK") === Success("20160606_1427"))

		// 4: With a change of day:
		assert(geoBase.localDateToGMT("20160606_2227", "NYC") === Success("20160607_0227"))

		// 5: French winter time:
		assert(geoBase.localDateToGMT("20160212_1627", "NCE") === Success("20160212_1527"))

		// 6: Another format:
		val computedGmtDate = geoBase.localDateToGMT(
			"2016-06-06T22:27", "NYC", "yyyy-MM-dd'T'HH:mm"
		)
		assert(computedGmtDate === Success("2016-06-07T02:27"))
	...
	test("Offset Getter from Local Date") {
		...
		assert(geoBase.getOffsetForLocalDate("20170712", "NCE", "yyyyMMdd") === Success(120))
	...
	test("GMT Date to Local Date") {
		...
		assert(geoBase.gmtDateToLocal("20160606_1427", "NCE", "yyyyMMdd_HHmm") === Success("20160606_1627"))

		// 2: LON
		assert(geoBase.gmtDateToLocal("20160606_1427", "LON") === Success("20160606_1527"))

		// 3: NYC:
		assert(geoBase.gmtDateToLocal("20160606_1427", "JFK") === Success("20160606_1027"))

		// 4: With a change of day:
		assert(geoBase.gmtDateToLocal("20160607_0227", "NYC") === Success("20160606_2227"))

		// 5: French winter time:
		assert(geoBase.gmtDateToLocal("20160212_1527", "NCE") === Success("20160212_1627"))

		// 6: Another format:
		val computedGmtDate = geoBase.gmtDateToLocal(
			"2016-06-07T02:27", "NYC", "yyyy-MM-dd'T'HH:mm"
		)
		assert(computedGmtDate === Success("2016-06-06T22:27"))
